...
#include "AutoIt3Wrapper_ISN_Addons.au3"
...
;~ 		__ConsoleWrite("! *************************************************************************************" & @CRLF)
	Else
		Global $TidypgmVer = ""
		Global $Tidypgm = $Tidy_exe_path
		Global $Tidypgmdir
		If FileExists($Tidypgm) Then
			$Tidypgmdir = $Tidy_pgmdir
...
;~ 		__ConsoleWrite("! *************************************************************************************" & @CRLF)
	...
	Else
		...
		Global $Au3Stripperpgm = $Au3Stripper_exe_path
		Global $Au3Stripperpgmdir
		If FileExists($Au3Stripperpgm) Then
			$Au3Stripperpgmdir = $Au3Stripper_pgmdir
...
Func Run_Au3Check($ScriptFile_In)
	...
	Local $Au3checkpgm = $Au3check_exe_path
	If FileExists($Au3checkpgm) Then
		$Au3checkpgmdir = $Au3check_pgmdir
...
;~ 	local $H_LegalCopyright, $H_FieldNameEdit, $H_Res_Language
	...
	GUISetHelp('"' & @WindowsDir & '\hh.exe" "' & @ScriptDir & '\..\Scite4AutoIt3.chm::/AutoIt3Wrapper.html"')
...
;~ 	GUICtrlSetTip($H_AUTOIT3_Ansi, "Check to compile with the Ansi version when Win9x/Me support is needed.")
	...
	GUICtrlCreateLabel("Au3Check Version: " & FileGetVersion($Au3check_exe_path), 400, 50, 180, 20, $SS_RIGHT)
	...
	; Run Tidy ?
	GUICtrlCreateLabel("Tidy Version: " & FileGetVersion($Tidy_exe_path), 400, 50, 180, 20, $SS_RIGHT)
	...
	; Run Au3Stripper ?
	GUICtrlCreateLabel("Au3Stripper Version: " & FileGetVersion($Au3Stripper_exe_path), 400, 50, 180, 20, $SS_RIGHT)
	...
	While 1
		...
		If $rc = $h_HelpFile Then
			Run('"' & @WindowsDir & '\hh.exe" "' & @ScriptDir & '\..\Scite4AutoIt3.chm::/AutoIt3Wrapper.html"')
			ContinueLoop
		EndIf
		If $rc = $h_About Then
			...
			Case $tab
				Switch GUICtrlRead($tab)
					...
					Case 4
						GUISetHelp('"' & @WindowsDir & '\hh.exe" "' & @ScriptDir & '\..\Scite4AutoIt3.chm::/AutoIt3Wrapper.html"')
					Case 5
						GUISetHelp('"' & @WindowsDir & '\hh.exe" "' & @ScriptDir & '\..\Scite4AutoIt3.chm::/tidy.html"')
					Case 6
						GUISetHelp('"' & @WindowsDir & '\hh.exe" "' & @ScriptDir & '\..\Scite4AutoIt3.chm::/Au3Stripper.html"')
					Case 7
						GUISetHelp('"' & @WindowsDir & '\hh.exe" "' & @ScriptDir & '\..\VersionWrapper\VersionWrapper.html"')
				EndSwitch
